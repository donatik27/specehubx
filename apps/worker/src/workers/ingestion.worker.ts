...
async function updateManualLocations() {
  ...
  const CITY_COORDS: Record<string, { lat: number; lon: number; maxOffset: number }> = {
    US_CHICAGO: { lat: 41.8781, lon: -87.6298, maxOffset: 2.5 },
    US_DALLAS: { lat: 32.7767, lon: -96.7970, maxOffset: 2.5 },
    US_DENVER: { lat: 39.7392, lon: -104.9903, maxOffset: 2.5 },
    US_ATLANTA: { lat: 33.7490, lon: -84.3880, maxOffset: 2.5 },
    US_MINNEAPOLIS: { lat: 44.9778, lon: -93.2650, maxOffset: 2.5 },
    CA_TORONTO: { lat: 43.6532, lon: -79.3832, maxOffset: 2.0 },
    CA_MONTREAL: { lat: 45.5017, lon: -73.5673, maxOffset: 2.0 },
    CA_CALGARY: { lat: 51.0447, lon: -114.0719, maxOffset: 2.0 },
    ...
    UK_BIRMINGHAM: { lat: 52.4862, lon: -1.8904, maxOffset: 1.5 },
    UK_MANCHESTER: { lat: 53.4808, lon: -2.2426, maxOffset: 1.5 },
    ...
    FR_PARIS: { lat: 48.8566, lon: 2.3522, maxOffset: 1.8 },
    FR_LYON: { lat: 45.7640, lon: 4.8357, maxOffset: 1.8 },
    DE_BERLIN: { lat: 52.5200, lon: 13.4050, maxOffset: 1.8 },
    DE_MUNICH: { lat: 48.1351, lon: 11.5820, maxOffset: 1.8 },
    IT_ROME: { lat: 41.9028, lon: 12.4964, maxOffset: 1.8 },
    IT_MILAN: { lat: 45.4642, lon: 9.1900, maxOffset: 1.8 },
    ...
    HK_SHENZHEN: { lat: 22.5431, lon: 114.0579, maxOffset: 2.0 },
    HK_GUANGZHOU: { lat: 23.1291, lon: 113.2644, maxOffset: 2.0 },
    TW_TAIPEI: { lat: 25.0330, lon: 121.5654, maxOffset: 1.5 },
    JP_TOKYO: { lat: 35.6762, lon: 139.6503, maxOffset: 2.0 },
    JP_NAGOYA: { lat: 35.1815, lon: 136.9066, maxOffset: 1.5 },
    KR_SEOUL: { lat: 37.5665, lon: 126.9780, maxOffset: 2.0 },
    KR_BUSAN: { lat: 35.1796, lon: 129.0756, maxOffset: 1.5 },
